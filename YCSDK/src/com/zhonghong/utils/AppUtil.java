...
public class AppUtil {
	...
	public static boolean startAppByPackgeName(Context context, String packgeName) {
	 ...
	 /**
     * 获取顶层应用包名，需要android.permission.GET_TASKS
     * @param context
     * @return
     */
    ...
    public static boolean isCurApp4Top(Context context){
    	return context.getPackageName().equals(getTopAppPackage(context));
    }
}
